...
if(!function_exists('of_options')) {
	function of_options() {
		...
		/*-----------------------------------------------------------------------------------*/
		/* TODO: Add options/functions that use these */
		/*-----------------------------------------------------------------------------------*/
		...
		$of_options[] = array(
			"name" 		=> "JQuery UI Slider example 1",
		...
		$of_options[] = array(
			"name" 		=> "JQuery UI Slider example 1 with steps(5)",
